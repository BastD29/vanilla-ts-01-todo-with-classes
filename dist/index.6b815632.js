...
var _status = require("./enums/status");
var _validate = require("./utils/validate");
var _appState = require("./components/appState");
class TodoInput {
    constructor(){
    ...
    validation(value) {
        const checkInput = (0, _validate.validate)({
            text: value,
            min: 3
        });
        if (!checkInput) {
    ...
    submitHandler(e) {
        ...
        if (ValidatedText) {
            ...
            (0, _appState.appState).addTodo(id, ValidatedText, (0, _status.STATUS).Pending);
            this.clearFormInput();
        } else this.clearFormInput();
    }
    submit() {
...
},{"./enums/status":"3a2DN","./utils/validate":"cJB2t","./components/appState":"aKRfK"}],"3a2DN":[function(require,module,exports) {
...
},{}],"cJB2t":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "validate", ()=>validate);
function validate(todo) {
    let isValid = true;
    if (todo.min && todo.text.length < todo.min) isValid = false;
    return isValid;
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"aKRfK":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "appState", ()=>appState);
var _todoStructure = require("../models/todoStructure");
...
class AppState {
    ...
    getTodoList() {
        new (0, _todoList.TodoList)(this.todos, "Pending");
        new (0, _todoList.TodoList)(this.todos, "Finished");
    }
    addTodo(id, input, status) {
        const todoItem = new (0, _todoStructure.TodoStructure)(id, input, status);
...
},{"../models/todoStructure":"4GYVT","./todoList":"13gaM","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4GYVT":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "TodoStructure", ()=>TodoStructure);
class TodoStructure {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"13gaM":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class TodoList {
    ...
    display() {
        ...
        for (let todo of this.todoItems)//console.log(todo);
        new (0, _todoItem.TodoItem)(todo.id, todo.input, this.todoItems);
    }
}

},{"./todoItem":"e6T3x","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"e6T3x":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class TodoItem {
    ...
    deleteItem(id, todoItems) {
        ...
        (0, _appState.appState).Todos = removedTodo;
    }
    deleteHandler() {
...
},{"./appState":"aKRfK","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["lSgxL","kuM8f"], "kuM8f", "parcelRequire84b1")
